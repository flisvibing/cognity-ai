...
`chat.py` will use the renamed folders `cognity_model/` and `cognity_tokenizer/`. If they are absent, Cognity uses the character-level LSTM checkpoint from `cognity_0.1.pt`.
